...
#================= AI ENGINES (GROQ FIRST FOR LIGHTNING FAST TEXT SPEED) =================
AI_ENGINES_POOL = [
    # ⚡ LIGHTNING FAST PRIMARY TEXT ENGINES (Put Groq first to bypass slow loops)
...
# ==========================================
# CORE ENGINE - FAST FAIL-FAST FAILOVER (<5s)
# ==========================================
...
# ==========================================
# FASTAPI SERVER - RENDER OPTIMIZED
# ==========================================
